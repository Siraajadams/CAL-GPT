  ...
  try {
    ...
    setAiStatus(
      data.recommendations
        ? `OpenAI analysis completed. Recommendation: ${data.recommendations}`
        : "OpenAI analysis completed. Review, then save meal to diary."
    );
  } catch (error: any) {
    setMealForm((p) => ({
      ...p,
    ...
    setAiStatus(`AI request failed: ${error?.message || "Unknown error"}`);
  }
}
  function addMeal() {
